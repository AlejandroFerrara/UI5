		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Worklist",
									"targetURL": "#comglobantholamundo4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comglobantholamundo4-display": {
								"semanticObject": "comglobantholamundo4",
								"action": "display",
								"description": "Prueba Data Binding",
								"title": "Worklist",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.globant.holamundo4",
									"url": sap.ui.require.toUrl("com/globant/holamundo4")
								}
							}
						}
					}
