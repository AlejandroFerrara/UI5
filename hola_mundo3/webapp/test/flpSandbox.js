		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hola Mundo",
									"targetURL": "#comglobantholamundo3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comglobantholamundo3-display": {
								"semanticObject": "comglobantholamundo3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.globant.holamundo3",
									"url": sap.ui.require.toUrl("com/globant/holamundo3")
								}
							}
						}
					}
