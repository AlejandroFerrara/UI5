		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hola Mundo",
									"targetURL": "#comglobantholamundo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comglobantholamundo-display": {
								"semanticObject": "comglobantholamundo",
								"action": "display",
								"description": "Primer programa UI5",
								"title": "Hola Mundo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.globant.holamundo",
									"url": sap.ui.require.toUrl("com/globant/holamundo")
								}
							}
						}
					}
