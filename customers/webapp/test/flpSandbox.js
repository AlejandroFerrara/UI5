		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "clientes",
									"targetURL": "#comglobantcustomers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comglobantcustomers-display": {
								"semanticObject": "comglobantcustomers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.globant.customers",
									"url": sap.ui.require.toUrl("com/globant/customers")
								}
							}
						}
					}
