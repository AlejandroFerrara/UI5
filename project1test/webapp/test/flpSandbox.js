		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comglobantproject1test-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comglobantproject1test-display": {
								"semanticObject": "comglobantproject1test",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.globant.project1test",
									"url": sap.ui.require.toUrl("com/globant/project1test")
								}
							}
						}
					}
