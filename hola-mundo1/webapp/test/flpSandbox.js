		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hola Mundo 1",
									"targetURL": "#comglobantholamundo1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comglobantholamundo1-display": {
								"semanticObject": "comglobantholamundo1",
								"action": "display",
								"description": "Mi 2do Hola Mundo",
								"title": "Hola Mundo 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.globant.holamundo1",
									"url": sap.ui.require.toUrl("com/globant/holamundo1")
								}
							}
						}
					}
